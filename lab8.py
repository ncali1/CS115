...
Fibonacci = '''
0       read    r1         # Get n
1       setn    r2 0       # Intialize r1
2       setn    r3 1       # Intialize r2
3       jeqzn   r1 10      # Done if r1 is 0
4       add     r4 r2 r3   # add r4 = r2 r3
5       write   r2         # print r2
6       copy    r2 r3      # set value r1 to r2
7       copy    r3 r4      # set value r3 to r4
8       addn    r1 -1      # change r1 = r1 -1
9       jumpn   3          # repeat
10      halt               # stop
'''
